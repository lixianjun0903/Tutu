...
NSString *const MJRefreshFooterReleaseToRefresh = @"";
NSString *const MJRefreshFooterRefreshing = @"";

NSString *const MJRefreshHeaderPullToRefresh = @"";
NSString *const MJRefreshHeaderReleaseToRefresh = @"";
NSString *const MJRefreshHeaderRefreshing = @"";
//NSString *const MJRefreshHeaderTimeKey = @"MJRefreshHeaderView";
NSString *const MJRefreshHeaderTimeKey = @"";
