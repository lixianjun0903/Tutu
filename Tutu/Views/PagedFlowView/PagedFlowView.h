...
#define CommentViewContentOffset    @"contentOffset"
 ...
 ******************************/
typedef NS_ENUM(NSInteger, PagedViewStatus) {
    statusNormal,
    StatusLoading,
...
@property(nonatomic)PagedViewStatus status;
@property(nonatomic,strong) UIImageView *commentImageV;
//向下加载的动画图
@property(nonatomic,strong)UIImageView *rightLoadingView;
//向上加载的动画图
@property(nonatomic,strong)UIImageView *leftLoadingView;
- (void)reloadData;
...
//选中的那个头像点击
- (void)flowView:(PagedFlowView *)flowView didTapSelectedPageAtIndex:(NSInteger)index;
//未选中的那个头像点击
- (void)flowView:(PagedFlowView *)flowView didTapDisSelectedPageAtIndex:(NSInteger)index;
